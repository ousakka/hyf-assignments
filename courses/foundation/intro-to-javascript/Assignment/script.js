...
const firstWords=["Easy","Smart","NextGen","Quick","Green","Tech","Bright","Future","Innovative","Dynamic"];
const secondWords=["Solutions","Systems","Technologies","Concepts","Designs","Ideas","Ventures","Labs","Works","Studios"];
